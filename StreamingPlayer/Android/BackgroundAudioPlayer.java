...
public final class BackgroundAudioPlayer
{
	...
	public void statusChanged(AndroidPlayerState state) {
		int intState = 0;
		switch (state) {
		case Idle: intState = 0; break;
		case Initialized: intState = 1; break;
		case Preparing: intState = 2; break;
		case Prepared: intState = 3; break;
		case Started: intState = 4; break;
		case Stopped: intState = 5; break;
		case Paused: intState = 6; break;
		case PlaybackCompleted: intState = 7; break; 
		case Error: intState = 8; break;
		case End: intState = 9; break;
		}
