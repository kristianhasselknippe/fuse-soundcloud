...
//TODO: Player buttons and notification buttons are not in sync
...
public final class BackgroundAudioService
	...
	public void onPrepared(MediaPlayer mp) {
		...
		_session.setPlaybackState(new PlaybackState.Builder()
								  ...
								  .build());
		_backgroundPlayer.statusChanged(AndroidPlayerState.Started);
	}

	public void Resume() {
		if (_player.isPlaying()) _player.seekTo(0);
		else if (_prepared) _player.start();
		_backgroundPlayer.statusChanged(AndroidPlayerState.Started);
	...
	public void Play(Track track){
		...
		try {
			...
			_backgroundPlayer.statusChanged(AndroidPlayerState.Preparing);
